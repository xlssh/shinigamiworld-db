...
export const ErrorState: React.FC<ErrorStateProps> = ({ message = "An error occurred while loading data.", onRetry }) => {
  return (
    <div className="flex flex-col items-center justify-center p-12 border border-red-200 dark:border-red-900 bg-red-50 dark:bg-red-950/20 rounded-xl max-w-xl mx-auto my-8">
